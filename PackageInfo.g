#############################################################################
##  
##  PackageInfo.g for the package `MapleForHomalg'            Thomas Bächler
...
#
PackageName := "MapleForHomalg",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "An interface between Maple and homalg using libmaplec",
...
#
README_URL := 
  "http://wwwb.math.rwth-aachen.de/~barakat/gap/MapleForHomalg/README.MapleForHomalg",
PackageInfoURL := 
  "http://wwwb.math.rwth-aachen.de/~barakat/gap/MapleForHomalg/PackageInfo.g",
...
PackageDoc := rec(
  # use same as in GAP            
  BookName  := "MapleForHomalg",
  # format/extension can be one of .zoo, .tar.gz, .tar.bz2, -win.zip
  Archive := 
    "http://wwwb.math.rwth-aachen.de/~barakat/gap/MapleForHomalg/MapleForHomalg.tar.gz",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["RingsForHomalg", ">=2009.03.13"], ["IO_ForHomalg", ">= 2009.05.14"], ["GAPDoc", ">= 1.0"], ["homalg", ">= 2009.03.26"]],
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  MapleForHomalg ", ~.Version, "\n",
...
#        " (", ~.Persons[3].WWWHome, ")\n",
  "Type:\n",
  "  ?MapleForHomalg:                   ## for the contents of the manual\n",
  "  ?MapleForHomalg:x                  ## for chapter/section/topic x\n",
  "----------------------------------------------------------------\n" ),
